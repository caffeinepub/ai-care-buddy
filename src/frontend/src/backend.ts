...
export class Backend implements backendInterface {
    ...
    async getHealthData(arg0: Principal): Promise<HealthData> {
        if (this.processError) {
            try {
                const result = await this.actor.getHealthData(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async logHealthData(arg0: HealthData): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logHealthData(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
